...
2. **Finds the real package folder** inside the downloaded files: not always obvious, since a package's install name and its actual code folder can differ (see `PyUpgrade-Intelligence-Design.md` for how this works).
